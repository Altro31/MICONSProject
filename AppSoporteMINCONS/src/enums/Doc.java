...
public enum Doc {
	...
	PROPIEDAD("PP", "Propiedad"), USUFRUCTO("US", "Usufructo"), VIV_VINCULADA("VV", "Viviendas Vinculada"),
	ARRENDAMIENTO("AR", "Arrendamiento"), PROVIDENCIA("PR", "Providencia"), INDOCUMENTADO("IN", "Indocumentado");
