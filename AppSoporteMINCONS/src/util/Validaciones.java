...
public final class Validaciones {
		...
		t.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
				...
				if (decimal) {
					...
					//Si el único caracter en el textField es un 0, y se inserta un número, borra el textField
			...
			//Pequeño arreglo ya que si se selecciona el texto y se sobreescribe, puede romper alguna de las validaciones definidas anteriormente
			@Override
	 ...
	 * 
	 * @see Se recomienda que a la variable check fuera del método se le asigne el valor de retorno de éste método, de otro modo, no funciona
	 */
	
	public static void relacionarSpinners(final JSpinner accionador, final JSpinner receptor, final PreviousValue check) {
